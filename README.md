...
| Method    | Command                                                                                           |
|:----------|:--------------------------------------------------------------------------------------------------|
| **curl**  | `sh -c "$(curl -fsSL https://raw.githubusercontent.com/jikama93/oh-my-zsh/main/tools/install.sh)"` |
| **wget**  | `sh -c "$(wget -O- https://raw.githubusercontent.com/jikama93/oh-my-zsh/main/tools/install.sh)"`   |
| **fetch** | `sh -c "$(fetch -o - https://raw.githubusercontent.com/jikama93/oh-my-zsh/main/tools/install.sh)"` |
...
```shell
wget https://raw.githubusercontent.com/jikama93/oh-my-zsh/main/tools/install.sh
sh install.sh
```
